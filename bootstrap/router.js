...
router.post(
  ...
  require('../controllers/bookcreate')
)
...
router.get(
  '/manageapprove',
  mustLogin,
  require('../controllers/manageapprove')
)
router.get(
  '/managecategory',
  mustLogin,
  require('../controllers/categorys/managecategory')
)
router.post(
  '/category/create',
  mustLogin,
  require('../controllers/categorys/addcategory')
)
router.post(
  '/category/update/:id',
  mustLogin,
  require('../controllers/categorys/editcategory')
)
router.get(
  '/category/delete/:id',
  mustLogin,
  require('../controllers/categorys/deletecategory')
)
router.get(
  '/manageteacher',
  mustLogin,
  require('../controllers/manageteacher')
)
...
router.post(
  '/teacher/create',
  mustLogin,
  require('../controllers/teachercreate')
)
router.get(
  '/book/approve/:id',
  mustLogin,
  require('../controllers/bookapprove')
)
router.post('/book/refer/:id', mustLogin, require('../controllers/bookrefer'))
router.post(
  '/book/dowload/:id',
  mustLogin,
  require('../controllers/bookdowload')
)
router.get(
  '/managedowload',
  mustLogin,
  require('../controllers/managedowload')
)
...
router.get(
  '/status/refer/:id',
  mustLogin,
  require('../controllers/statusrefer')
)
router.get(
  '/status/dowload/:id',
  mustLogin,
  require('../controllers/statusdowload')
)
router.get(
  '/teachers/delete/:id',
  mustLogin,
  require('../controllers/deleteteacher')
)
